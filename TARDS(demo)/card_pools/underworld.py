...
register_card(
    ...
    attack=4,
    health=5,
    keywords={"先攻": 1, "兴奋": True},
    description="对攻击力≤3的异象伤害+3。",
    targets_fn=target("position", friendly=True),
    special_fn=_zongxiong_special,
)
...
register_card(
    ...
    description="处于协同时，受到的战斗伤害翻倍。（先翻倍再坚韧）",
    targets_fn=target("position", friendly=True),
    special_fn=_lugui_special,
)
...
register_card(
    ...
    tags=['两栖'],
    description="受到伤害时，改为失去1点HP。无法获得HP（含最大生命值加成）。",
    targets_fn=target("position", friendly=True),
    special_fn=_yao_special,
)
...
register_card(
    ...
    description="受到伤害后，对伤害来源造成等量伤害（原始伤害）。",
    targets_fn=target("position", friendly=True),
    special_fn=_haozhu_special,
)
...
register_card(
    ...
    tags=['两栖'],
    description="部署：消灭场上攻击力最低的异象（不含自身），获得其攻击力与防御力（叠加）。",
    targets_fn=target("position", friendly=True),
    special_fn=_linwa_special,
)
...
register_card(
    ...
    health=8,
    keywords={"坚韧": 1, "先攻": -1},
    description="部署：对所有异象造成1点伤害。结算阶段开始: 随机眩晕一个敌方异象。",
    targets_fn=target("position", friendly=True),
...
register_card(
    ...
    keywords={"成长": 2},
    evolve_to="成鸟",
    description="部署：指向一个友方飞禽异象，使其获得+3防御力和“友方幼鸟虚化”。",
    targets_fn=target("position", friendly=True),
...
register_card(
    ...
    targets_fn=target("position", friendly=True),
    on_evolve_fn=_chengniao_evolve,
)
...
register_card(
    ...
    targets_fn=target("position", friendly=True),
    hidden_keywords={"抽取": _qiguai_de_yong_draw_trigger},
)
...
register_card(
    ...
    health=1,
    keywords={"协同": True},
    description="每有一个其它异象被献祭，+1/1，丰饶等级+1。",
    targets_fn=target("position", friendly=True),
    special_fn=_qunyuan_special,
)
...
register_card(
    ...
    attack=3,
    health=8,
    description="敌方场上异象数量变化时，对对手造成1点伤害。",
    targets_fn=target("position", friendly=True),
    special_fn=_yexiao_special,
)
...
register_card(
    ...
    attack=3,
    health=5,
    keywords={"坚韧": 1, "水生": True},
    tags=['水生'],
    description="结算阶段结束：指向一个异象。结算阶段开始：消灭指向异象。",
    targets_fn=target("position", friendly=True),
    special_fn=_ankang_special,
)
...
register_card(
    ...
    targets_fn=target("position", friendly=True),
    special_fn=_shiyi_shou_special,
    hidden_keywords={"抽取": _shiyi_shou_draw_trigger},
)
...
register_card(
    ...
    attack=0,
    health=1,
    keywords={"协同": True, "虚化": True},
    tags=['生物', '陆生'],
    is_token=True,
    description="你的手牌花费+1T。具有虚化。",
    targets_fn=target("position", friendly=True),
    special_fn=_lao_lu_special,
    on_evolve_fn=_lao_lu_evolve,
)
...
register_card(
    ...
    targets_fn=target("position", friendly=True),
    special_fn=_xintianweng_special,
)
...
register_card(
    ...
    targets_fn=target("position", friendly=True),
    special_fn=_zhuiliezhe_special,
)
...
register_card(
    ...
    health=6,
    keywords={"坚韧": 1},
    description="攻击目标的HP不大于3时，本异象具有串击。",
    targets_fn=target("position", friendly=True),
    special_fn=_yeniue_special,
)
...
register_card(
    ...
    attack=3,
    health=3,
    keywords={"防空": True, "迅捷": True},
    tags=['昆虫'],
    description="直到本异象被部署的出牌阶段结束，友方异象部署时，本异象失去迅捷。你部署献祭点数大于0的异象时，对对手造成1点伤害。",
    targets_fn=target("position", friendly=True),
    special_fn=_tiaozhu_special,
)
...
register_card(
    ...
    targets_fn=target("position", friendly=True),
    effect_fn=_mang_effect,
    special_fn=_mang_special,
)
...
register_card(
    ...
    tags=['水生', '两栖', '生物'],
    is_token=True,
    description="抽牌阶段：对方失去2T。",
    targets_fn=target("position", friendly=True),
    special_fn=_shuixiqun_special,
)
...
register_card(
    ...
    keywords={"亡语": True},
    tags=['昆虫'],
    description="亡语：T槽更多的一方失去1个T槽。",
    targets_fn=target("position", friendly=True),
    special_fn=_yachong_special,
)
...
register_card(
    ...
    keywords={"协同": True},
    tags=['昆虫'],
    description="对方所有异象具有+2T花费。对方异象部署前，本异象返回手牌。",
    targets_fn=target("position", friendly=True),
    special_fn=_wen_special,
)
...
register_card(
    ...
    health=3,
    keywords={"协同": True},
    description="友方异象更少时，使所有敌方异象具有-2攻击力。",
    targets_fn=target("position", friendly=True),
    special_fn=_luci_special,
)
...
register_card(
    ...
    keywords={"亡语": True},
    tags=['昆虫'],
    description="部署：指向一个异象。亡语：使指向目标与随机一个敌方异象对战。",
    targets_fn=target("position", friendly=True),
    special_fn=_huanxingchong_special,
)
...
register_card(
    ...
    rarity=Rarity.IRON,
    immersion_level=1,
    description="将一只“松鼠”加入战场，本回合所有B=0友方异象具有虚化。",
    targets_fn=target_none,
...
register_card(
    ...
    rarity=Rarity.BRONZE,
    immersion_level=3,
    description="手牌数不大于3时，花费-2T。随机将对方一张手牌放置至其卡组顶，你抽1张牌。",
    targets_fn=target_none,
...
register_card(
    ...
    rarity=Rarity.SILVER,
    immersion_level=2,
    description="你的所有异象具有+2攻击力和坚韧1，直到结算阶段结束。",
    targets_fn=target_none,
...
register_card(
    ...
    rarity=Rarity.IRON,
    immersion_level=2,
    description="使手牌中一个异象获得 +1/2 和亡语：对方抽1张牌。",
    targets_fn=target_none,
...
register_card(
    ...
    rarity=Rarity.BRONZE,
    immersion_level=1,
    description="对所有陆地异象造成2点伤害，然后使所有陆地异象+1/1。你失去1个T槽。",
    targets_fn=target_none,
...
register_card(
    ...
    rarity=Rarity.BRONZE,
    immersion_level=2,
    description="造成等同于水路异象攻击力总和的伤害，随机分配到所有敌方异象。",
    targets_fn=target_none,
...
register_card(
    ...
    rarity=Rarity.BRONZE,
    immersion_level=2,
    description="随机眩晕一个敌方异象。抉择：重复一次 或 抽1张牌。",
    targets_fn=target_none,
...
register_card(
    ...
    rarity=Rarity.GOLD,
    immersion_level=1,
    description="你获得：阴谋的花费-1T。你的阴谋每被触发2次，不论何处，将此卡加入你的手牌。",
    targets_fn=target_none,
